...
public class DesktopTest {
	...
	desktop.addApplication(new IconID((short) 1), new ColorID((short) 2), "APPLICATION 1", appId, Boolean.TRUE);
	...
	desktop.addPage(new IconID((short) 1), new ColorID((short) 2), "PAGE 1", pageId, Boolean.TRUE);
	Assert.assertTrue(desktop.getItems().size() == 1);
	Assert.assertTrue(desktop.getItems()
				 .stream()
